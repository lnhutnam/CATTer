...
class MLE_Dirchlet(object):
    def __init__(
        ...
        # The number of occurrences of the entity at each time in the training set
        self.entity_occ_times = self.get_entity_occ_times(trainQuads)
    ...
    def get_entity_occ_times(self, trainQuads):
        # key -> entity, value -> dict [key: time, value: times]
        entity_occ_times = {}
