...
class baseDataset(object):
    def __init__(self, trainpath, testpath, statpath, validpath):
        ...
        self.allQuadruples = (
            self.trainQuadruples + self.validQuadruples + self.testQuadruples
        )
        self.num_e, self.num_r = self.get_total_number(
            statpath
        )  # number of entities, number of relations
        ...
        self.RelEntCooccurrence = self.getRelEntCooccurrence(
            self.trainQuadruples
        )  # -> dict
